...
test.describe("API: GET /api/tasks/{taskId}/comments — List Comments", () => {
  ...
  test("TC-TASK-COMMENTS-001: Owner gets comments (happy path) → 200 OK", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
  ...
  test("TC-TASK-COMMENTS-002: Member gets comments → 200 OK", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
  ...
  test("TC-TASK-COMMENTS-003: No token → 401 Unauthorized", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
  ...
  test("TC-TASK-COMMENTS-004: Non-member cannot get comments → 404 Not Found", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
  ...
  test("TC-TASK-COMMENTS-005: Non-existent task → 404 Not Found", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
  ...
  test("TC-TASK-COMMENTS-006: Invalid taskId format → Route constraint rejects", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
  ...
  test("TC-TASK-COMMENTS-007: SQL Injection → Route constraint rejects", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
  ...
  test("TC-TASK-COMMENTS-008: Empty state (task has no comments)", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
  ...
  test("TC-TASK-COMMENTS-009: Check comment sorting order (oldest first)", async ({ request, owner, member, nonMember, member2, assignee, user }) => {
